...
Frame the review neutrally. [Sycophancy](./Sycophancy.md) can skew the verdict if the prompt says the author is proud of the change or expects the reviewer to find problems.
