...
Tool definitions and standing repository instructions count too, even when the agent never uses them during the task. [Context engineering](./Context%20engineering.md) therefore affects cost before the first file is read.
